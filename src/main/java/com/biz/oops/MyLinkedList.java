...
public class MyLinkedList<T>{
    ...
    //search and returns true if the element is in the list else returns false
    ...
    //returns position of the element in the list if it is in the list else returns -1
